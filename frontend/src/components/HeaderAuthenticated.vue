    ...
    <header class="pt-10">
      <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
          ...
          <div v-if="localIsLoggedIn" class="flex justify-start items-center">
            ...
            <RouterLink to="/" class="flex items-center justify-between mr-4">
                <span class="self-center"><img src="@/assets/bhdc-logo-no-tag.png" alt="BHDC logo"
                class="h-12" /> </span>
                <span class="text-xl font-semibold ml-2 text-gray-400 dark:text-gray-200">New York</span>
            </RouterLink>
          ...
          <div v-else class="flex justify-start items-center">
            <RouterLink to="/" class="flex items-center justify-between mr-4">
                <span class="text-xl ml-2 text-gray-500 dark:text-gray-200">About</span>
            </RouterLink>
            <RouterLink to="/" class="flex items-center justify-between mr-4">
                <span class="text-xl ml-2 text-gray-500 dark:text-gray-200">Contact</span>
            </RouterLink>
          </div>
  
          <div v-if="localIsLoggedIn" class="flex items-center lg:order-2">
            ...
            <button type="button"
              ...
              <img class="w-8 h-8 rounded-full"
                src="@/assets/patrick_image.png" alt="user photo" />
            </button>
            <!-- Dropdown menu -->
            <div
              ...
              id="dropdown">
              <div class="py-3 px-4">
                <span class="block text-sm font-semibold text-gray-900 dark:text-white">Patrick Gauthier</span>
                <span class="block text-sm text-gray-900 truncate dark:text-white">pgauthier@ahpnet.com</span>
              </div>
          ...
          <div v-else class="flex items-center lg:order-2">
            <span class="text-xl ml-2 text-gray-500 dark:text-gray-200">Login</span>
          </div>
